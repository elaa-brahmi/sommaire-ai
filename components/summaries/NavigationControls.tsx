...
export function NavigationControls({
        ...
        className={cn(
            'rounded-full w-12 h-12 transition-all duration-200 bg-linear-to-br from-rose-500 to-rose-600 backdrop-blur-xs border brder-rose-500/10',
            ...
            {Array.from({ length: totalSections }).map((_,
            index) => (
            <button
            key={index}
